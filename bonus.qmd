...
<div style="margin: 40px auto; width: 400px; text-align:center;">
  ...
  <canvas id="gameCanvas" width="400" height="300" style="border:1px solid #ccc; background-color: #f0f0f0;"></canvas><br/>
  <button onclick="jump()" style="background-color: #f0f0f0;">Jump!</button>
</div>
